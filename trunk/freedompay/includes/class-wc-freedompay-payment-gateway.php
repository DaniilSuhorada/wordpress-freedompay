...
class WC_Freedompay_Payment_Gateway extends WC_Payment_Gateway
{
    ...
    public function setup_constants()
    {
        ...
        define('FPWC_ERR_CONNECT_FAILED', __('Failed to connect to Freedom Pay', 'freedompay-payment-gateway'));
        define('FPWC_ERR_INVALID_SIGNATURE', __('Security signature mismatch', 'freedompay-payment-gateway'));
        define('FPWC_ERR_MERCHANT_ID_MISMATCH', __('Merchant ID mismatch', 'freedompay-payment-gateway'));
        define('FPWC_ERR_NO_SESSION', __('No saved session found for ITN transaction', 'freedompay-payment-gateway'));
        define('FPWC_ERR_ORDER_ID_MISSING_URL', __('Order ID not present in URL', 'freedompay-payment-gateway'));
        ...
        define('FPWC_ERR_ORDER_NUMBER_MISMATCH', __('Order Number mismatch', 'freedompay-payment-gateway'));
        define('FPWC_ERR_ORDER_PROCESSED', __('This order has already been processed', 'freedompay-payment-gateway'));
        define('FPWC_ERR_PDT_FAIL', __('PDT query failed', 'freedompay-payment-gateway'));
        define('FPWC_ERR_PDT_TOKEN_MISSING', __('PDT token not present in URL', 'freedompay-payment-gateway'));
    ...
    private function generateReceiptPositions($orderId)
    {
        ...
        $this->data_to_send['pg_receipt_positions'][0]['price'] += $sumDifference;
    }
